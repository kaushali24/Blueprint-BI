"""
conftest.py — shared pytest fixtures for the business data API tests.

Uses an in-memory SQLite database so tests never touch the production database.
FastAPI's TestClient is used for HTTP-level testing.
"""
